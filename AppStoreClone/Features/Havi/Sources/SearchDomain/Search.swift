...
public struct SearchAPIResult: Decodable {
...
extension SearchAPIResult {
    public struct SearchResult: Decodable {
        ...
        public let averageUserRating: String // - 전체 평점
        public let averageUserRatingForCurrentVersion: String // - 이 버전에 대한평점 0.0~5.0
